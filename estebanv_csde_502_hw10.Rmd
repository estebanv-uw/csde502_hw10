...
## Data
Population and mortality data were obtained from the [Human Mortality Database](https://www.mortality.org/) a collaborative initiative by the UC Berkeley Department of Demography and the Max Planck Institute for Demographic Research.